...
<TauriInit
  destDirExplination={{
    __html: 'Use WINDOWS 10 had to use<code>..</code> for this value.',
  }}
  devPathExplination={{
    __html: 'Use WINDOWS 10 had to use<code>..</code> for this value.',
  }}
...
We would normally be recommending the [`@tauri-apps/api`] package here, but since we're not using a bundler for this guide, please enable [`withGlobalTauri`] in your WINDOWS 10 had to use `tauri.conf.json` file:
